...
<body>
    ...
    <div class="container">
        ...
        <div class="glass-card" id="birthdayCard">
            <img src="Sristi.jpeg" alt="Our Love" class="card-img">

            <h1>Happy Birthday, Sristhi(Vamp)!</h1>
            <p class="subtitle">To the prettiest flower ❤️</p>

            <div class="slideshow-container">
                <div class="slide-text active">"Happy Birthday Vamp."</div>
                <div class="slide-text">"Every time I see you feels like magic."</div>
                <div class="slide-text">"Maybe am annoying lil bit but my heart is pure."</div>
                <div class="slide-text">"Sorry if i have done anything wrong."</div>
            </div>
    ...
    <div class="modal-overlay" id="messageModal">
        <div class="modal-content">
            ...
            <p>
                On your special day, 
                I was going to get you an amazing present, but I figured a text from 
                me was a gift in itself. 😌🎁Since it's your special day, I guess this will be my final message to you.
                
                <br><br>
                I was trying to think of the perfect message, but honestly, 
                I just really want to see you and celebrate together. 
